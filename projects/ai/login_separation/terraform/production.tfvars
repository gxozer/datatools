...
# FIXME: Replace 0.0.0.0/0 with your VPN/office CIDR(s) before going live.
# Leaving the EKS API endpoint open to the internet exposes it to automated
# scanners and brute-force attempts against the Kubernetes control plane.
